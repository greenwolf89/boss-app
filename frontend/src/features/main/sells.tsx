const SellOne = () => {
    const sellsData = [
        {"alignRight": false, "num": 1, "h1": "This should be a title", "h2": "This should be a smaller title", "imageURL": "https://cdn.pixabay.com/photo/2018/08/18/13/26/interface-3614766_960_720.png"},
